## whiteboard-app 
whiteboard app is an interactive drawing application developed using HTML,CSS and Javascript. The application alows users to draw freely on a digital canvas with smooth brush strokes and responsive controls. 
